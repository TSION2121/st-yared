                ...
                <Grid item xs={12} sm={6} md={4}>
                    <Card>
                        <CardMedia
                            ...
                            alt={t('study_online.language')}
                        />
                        <CardContent>
                            <Typography variant="h6">{t('study_online.language')}</Typography>
                            <Typography variant="body2">
                                {t('study_online.language_description')}
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4}>
                    <Card>
                        <CardMedia
                            ...
                            alt={t('study_online.literature')}
                        />
                        <CardContent>
                            <Typography variant="h6">{t('study_online.literature')}</Typography>
                            <Typography variant="body2">
                                {t('study_online.literature_description')}
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4}>
                    <Card>
                        <CardMedia
                            ...
                            alt={t('study_online.music')}
                        />
                        <CardContent>
                            <Typography variant="h6">{t('study_online.music')}</Typography>
                            <Typography variant="body2">
                                {t('study_online.music_description')}
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
